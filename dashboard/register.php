<?php
  ...
  if (isset($_POST['register'])) {
    ...
    // requete
    $user_check_query = "SELECT * FROM gerant WHERE email='$email' OR telephone='$telephone' LIMIT 1";
    ...
    if (count($errors) == 0) {
      ...
      $query = '';
      // execution de la requete
      mysqli_query($db,"INSERT INTO gerant (nom,prenom,email,telephone,password,is_admin,date_create) VALUES ('$nom','$prenom','$email','$telephone','$password',false,'$datepost')");
      // close database
      mysqli_close($db);
      // redirection
